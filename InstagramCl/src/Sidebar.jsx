...
import instext from "./assets/instext.png"
...
function Sidebar() {
    ...
    return (
        <div className="position-fixed top-0 m-3">
            <div className="d-flex flex-column gap-3">
                <img className='logo-text' src={instext} />
                ...
                <div><i className="bi bi-journal-plus"></i>Create</div>
